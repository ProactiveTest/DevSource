...
namespace Ijuba.Webclient.Client.Components.EntityTable;

public partial class InvoiceDetailsEntityTable<TEntity, TId, TRequest>
    where TRequest : new()
{
    [Parameter]
    [EditorRequired]
